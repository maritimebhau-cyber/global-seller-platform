    ...
    <>
      ...
      {showSuggestionPopup && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-full max-w-lg mx-4 rounded-lg shadow-2xl overflow-hidden">
            {/* Header */}
            ...
            <div className="p-6">
              <textarea
                ...
                className="w-full h-40 p-4 border border-gray-300 rounded-lg resize-none focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 text-gray-700 placeholder-gray-400"
              />
              ...
              <button 
                ...
                className="w-full mt-6 bg-teal-500 hover:bg-teal-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-lg transition-colors"
              >
                Submit
              </button>
            </div>
      ...
      <div className="w-65 bg-white min-h-screen p-4 flex flex-col font-sans">
        ...
        <nav className="flex flex-col gap-1">
          ...
          {/* Any Suggestion - Opens Suggestion Popup */}
          <div
            onClick={() => {
