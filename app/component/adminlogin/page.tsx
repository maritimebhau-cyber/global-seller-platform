...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <Head>
        <title>Admin Login | MarineMart</title>
      </Head>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12 text-white">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-bold mb-4 leading-tight">
              ...
              <span className="text-green-300">Business Empire</span>
            </h2>
            <p className="text-lg text-blue-100 max-w-md leading-relaxed">
              Access powerful tools to manage listings, track orders, and grow your maritime business globally.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  type="email"
                  placeholder="admin@marinemart.com"
                  value={email}
